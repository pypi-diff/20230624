# Comparing `tmp/Scrapset-2.4.0.tar.gz` & `tmp/Scrapset-3.1.0.tar.gz`
...
## Comparing `Scrapset-2.4.0.tar` & `Scrapset-3.1.0.tar`
...
### Comparing `Scrapset-2.4.0/PKG-INFO` & `Scrapset-3.1.0/PKG-INFO`
...
### Comparing `Scrapset-2.4.0/README.md` & `Scrapset-3.1.0/README.md`

 * *Files identical despite different names*

### Comparing `Scrapset-2.4.0/Scrapset/Scrapset.py` & `Scrapset-3.1.0/Scrapset/Scrapset.py`
...
### Comparing `Scrapset-2.4.0/Scrapset.egg-info/PKG-INFO` & `Scrapset-3.1.0/Scrapset.egg-info/PKG-INFO`
...
### Comparing `Scrapset-2.4.0/licence.txt` & `Scrapset-3.1.0/licence.txt`
