# Comparing `tmp/SpaGoG-0.16.tar.gz` & `tmp/SpaGoG-0.17.tar.gz`
...
## Comparing `SpaGoG-0.16.tar` & `SpaGoG-0.17.tar`
...
### Comparing `SpaGoG-0.16/setup.py` & `SpaGoG-0.17/setup.py`
...
### Comparing `SpaGoG-0.16/spagog/main.py` & `SpaGoG-0.17/spagog/main.py`

 * *Files identical despite different names*

### Comparing `SpaGoG-0.16/spagog/experiments.py` & `SpaGoG-0.17/spagog/experiments.py`
