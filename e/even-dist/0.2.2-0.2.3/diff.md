# Comparing `tmp/even-dist-0.2.2.tar.gz` & `tmp/even-dist-0.2.3.tar.gz`
...
## Comparing `even-dist-0.2.2.tar` & `even-dist-0.2.3.tar`
...
### Comparing `even-dist-0.2.2/LICENSE` & `even-dist-0.2.3/LICENSE`

 * *Files identical despite different names*

### Comparing `even-dist-0.2.2/setup.py` & `even-dist-0.2.3/setup.py`
