# Comparing `tmp/BeeDrive-0.3.5.4.tar.gz` & `tmp/BeeDrive-0.3.5.5.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "dist\BeeDrive-0.3.5.4.tar", last modified: Thu Mar 24 02:53:32 2022, max compression
+gzip compressed data, was "BeeDrive-0.3.5.5.tar", last modified: Fri Jun 23 22:52:17 2023, max compression
```

## Comparing `BeeDrive-0.3.5.4.tar` & `BeeDrive-0.3.5.5.tar`

### file list

```diff
@@ -1,4 +1,4 @@
-drwxrwxrwx   0        0        0        0 2022-03-24 02:53:32.000000 BeeDrive-0.3.5.4/
--rw-rw-rw-   0        0        0    11136 2022-03-24 02:53:32.000000 BeeDrive-0.3.5.4/PKG-INFO
--rw-rw-rw-   0        0        0       42 2022-03-24 02:53:32.000000 BeeDrive-0.3.5.4/setup.cfg
--rw-rw-rw-   0        0        0     1439 2022-02-08 18:45:13.000000 BeeDrive-0.3.5.4/setup.py
...
### Comparing `BeeDrive-0.3.5.4/PKG-INFO` & `BeeDrive-0.3.5.5/PKG-INFO`
...
### Comparing `BeeDrive-0.3.5.4/setup.py` & `BeeDrive-0.3.5.5/setup.py`
