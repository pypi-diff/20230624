# Comparing `tmp/simplug-0.3.0.tar.gz` & `tmp/simplug-0.3.1.tar.gz`
...
## Comparing `simplug-0.3.0.tar` & `simplug-0.3.1.tar`
...
### Comparing `simplug-0.3.0/LICENSE` & `simplug-0.3.1/LICENSE`

 * *Files identical despite different names*

### Comparing `simplug-0.3.0/README.md` & `simplug-0.3.1/README.md`

 * *Files identical despite different names*

### Comparing `simplug-0.3.0/pyproject.toml` & `simplug-0.3.1/pyproject.toml`
...
### Comparing `simplug-0.3.0/simplug.py` & `simplug-0.3.1/simplug.py`
...
### Comparing `simplug-0.3.0/setup.py` & `simplug-0.3.1/setup.py`
...
### Comparing `simplug-0.3.0/PKG-INFO` & `simplug-0.3.1/PKG-INFO`
